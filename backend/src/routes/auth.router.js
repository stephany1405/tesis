...
import { createSecretPassword } from "../controllers/backup.controller.js";
...
router.post("/change-secret-password", createSecretPassword);
router.post("/secret-forgot-password", authCtrl.SecretforgotPassword);
