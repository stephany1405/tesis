...
import { User, UserPlus, Mail, Phone, Lock, Calendar, CreditCard, Eye, EyeOff, Shield, HelpCircle } from "lucide-react"
...
const Registro = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({ ...errors, form: "Error al registrar. Por favor, inténtelo de nuevo." })
    }
  }
  ...
  }, [formData, validateConfirmPassword]) // Added validateConfirmPassword to dependencies
        ...
        <div className={styles.formGrid}>
          ...
          <div className={styles.inputGroup}>
            ...
            >
              ...
              <option value="escuela">¿Cuál fue el nombre de su primera escuela?</option>
            </select>
          </div>
